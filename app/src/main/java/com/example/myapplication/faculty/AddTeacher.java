...
import com.example.myapplication.NoticeData;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items= new String[]{"Select category","Computer science","commerce","arts","Other events"};
    ...
    private void checkValidation() {
        ...
        name=addTeacherEmail.getText().toString();
        name=addTeacherPost.getText().toString();
        if(name.isEmpty()){
